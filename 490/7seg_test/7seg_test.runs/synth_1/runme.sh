...
HD_PWD='C:/Users/arody/Documents/490/7seg_test/7seg_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log 7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source 7seg.tcl
